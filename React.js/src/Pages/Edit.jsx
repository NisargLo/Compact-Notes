        ...
        <>
            <div className="px-5">
                <div class="mb-5">
                    ...
                    <input type="text" class="form-control border border-dark border-3" id="formGroupExampleInput" placeholder="Enter Title" style={{ fontSize: '1.25rem' }} value={note.name} />
                </div>
                <div class="mb-5">
                    <label for="formGroupExampleInput" class="form-label" style={{ fontSize: '3rem' }}>Picture</label>
                    <input type="text" class="form-control border border-dark border-3" id="formGroupExampleInput" placeholder="Enter Picture URL" style={{ fontSize: '1.25rem' }} value={note.image} />
                </div>
                <div class="mb-3">
                    ...
                    <textarea
                        ...
                        style={{ fontSize: '1.25rem', height: '10rem' }} value={note.description} />
                </div>
